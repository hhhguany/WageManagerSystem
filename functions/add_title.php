...
$wage = $_POST["wage"];
$query_all_title="SELECT * FROM professional_title";
$query_all_title_result=$con->query($query_all_title);
$title_code=$query_all_title_result->num_rows;
...
if ($_POST) {
    ...
    echo '<script>location.href="../add_title.php";</script>';
}
?>