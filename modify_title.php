...
$action="functions/modify_title.php?title_code=".$title_code;
?>
...
<div class="container" style="padding-top: 20px;">
    ...
    <div class="panel" id="wage_panel">
        <div class="panel-heading text-center"><strong>职称列表</strong></div>
        <div class="panel-body">
            ...
            <table class="table table-bordered table-hover table-striped text-center">
                ...
                <?php
                print_single_title_info($con, $title_code);
                ?>
        ...
        <form action=<?php echo $action;?> role="form" method="post">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label for="title_code"><strong>序号: <?php echo $title_code;?></strong></label>
                </div>
                <div class="form-group">
                    <label for="title_name">职称名称</label>
                    <input type="text" class="form-control" id="title_name" name="title_name" placeholer="职称名称">
                </div>
                <div class="form-group">
                    <label for="wage">职称工资</label>
