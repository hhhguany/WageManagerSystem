...
<body style="padding-top: 70px;">
    ...
    <div class="container" style="padding-top: 50px;  padding-bottom: 40px;">
        <div class="panel">
            <form action="functions/add_user.php" role="form" method="post">
                <div class="panel-heading text-center">
                    <strong>添加用户</strong>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <label for="staff_number">工号（六位数字）</label>
                        <input type="text" class="form-control" id="staff_number" name="staff_number" placeholer="工号">
                    </div>
                    <div class="form-group">
                        <label for="staff_name">姓名</label>
                        <input type="text" class="form-control" id="staff_name" name="staff_name" placeholer="姓名">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="staff_password" name="staff_password" placeholer="密码">
                    </div>
                    <div class="form-group">
                        <label for="reenter_password">确认密码</label>
                        <input type="password" class="form-control" id="reenter_password" name="reenter_password" placeholer="确认密码">
                    </div>
                </div>
